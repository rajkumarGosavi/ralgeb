...
use crate::utils::{delta_x, delta_y};
use std::fmt;
#[derive(Debug)]
...
impl Line {
  ...
  pub fn slope(self) -> f64 {
    let del_y = delta_y(self.point2.y, self.point1.y);
    let del_x = delta_x(self.point2.x, self.point1.x);
    (del_y / del_x) as f64
  }
  #[allow(dead_code)]
  pub fn theta(self) -> f64 {
    let del_y = delta_y(self.point2.y, self.point1.y) as f64;
    let del_x = delta_x(self.point2.x, self.point1.x) as f64;
    del_y.atan2(del_x)
  }
}
